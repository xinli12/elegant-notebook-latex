...
% --- FONT SELECTION ---
% Font theme is now set using \usetheme in the main document
% \fonttheme is already defined by the theme system
...
% To switch themes, change the \fonttheme value above before including this file
...
\newtcolorbox{notetbox}{
    ...
    arc=2mm,
    drop shadow, % Subtle drop shadow
    breakable % Allow box to break across pages
}

\newtcolorbox{exampletbox}{
    enhanced,
...
\usepackage[backend=biber, style=numeric, sorting=none]{biblatex} % Use numeric style for numbered references
