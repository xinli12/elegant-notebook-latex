...
% -----------------------------------------------------
% THEME SHOWCASE DEFINITIONS
% -----------------------------------------------------
% These colours are for showcasing the themes in the document.
% We define a unique color for each theme's maincolor to be used in the theme list.
% Theme names with hyphens are renamed, e.g., 'cambridge-blue' becomes 'showcasecambridgeblue'.

% Cambridge Family
\definecolor{showcasecambridgeblue}{RGB}{133,176,154}
\definecolor{showcasecambridgeclassic}{RGB}{133,176,154}
\definecolor{showcasecambridgeforest}{RGB}{133,176,154}
\definecolor{showcasecambridgesunset}{RGB}{133,176,154}
\definecolor{showcasecambridgeriver}{RGB}{133,176,154}

% Oxford Family
\definecolor{showcaseoxfordblue}{RGB}{0,33,71}
\definecolor{showcaseoxfordmist}{RGB}{0,33,71}
\definecolor{showcaseoxfordmonochrome}{RGB}{0,33,71}

% Sky Family
\definecolor{showcasesummerskies}{RGB}{85,150,205}
\definecolor{showcaseauroraskies}{RGB}{60,125,150}
\definecolor{showcasetwilightskies}{RGB}{90,100,160}
\definecolor{showcasemidnightskies}{RGB}{45,60,110}

% Other Themes
\definecolor{showcasevintagerose}{RGB}{196,146,151}
\definecolor{showcaseemerald}{RGB}{0,112,74}
\definecolor{showcaseroyalpurple}{RGB}{76,40,130}
\definecolor{showcasearctic}{RGB}{64,103,129}
\definecolor{showcaseautumn}{RGB}{165,82,42}
